...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void btnPrimeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPrimeMouseClicked
        // Exercice n°1                     
          ...
          {
            JOptionPane.showMessageDialog(this, "Saisir un âge.");
          }
          else
          {
          ...
          { lblPrime.setText("Vous ne payez pas la surprime");
             ...
             if(cboSexe.getSelectedItem().toString().compareTo("Femme")==0 && Integer.parseInt(txtAge.getText())> 20 && Integer.parseInt(txtAge.getText())< 30)
          {
                 lblPrime.setText("Vous payez la surprime");
          } 
             else
...
// Exercice n°3
        ...
        {
            JOptionPane.showMessageDialog(this,"Veuillez saisir un prix.");
        }
        else if(sldNbJours.getValue()>7)
        {
             JOptionPane.showMessageDialog(this,"Aucun remboursement");
                ...
                if(cboCategories.getSelectedItem()=="Livres")
        {
                    ...
                    lblRemboursement.setText("Nous remboursons");
        }
